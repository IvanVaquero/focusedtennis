        ...
        <div class="benefit-card group" @click="scrollTo('#how-it-works')">
          <div class="benefit-image mentorship-bg">
            ...
            <div class="benefit-content">
              ...
              <p class="benefit-description">Work side to side with top coaches</p>
            </div>
          </div>
        </div>
      </div>
...
/* Background Images - using CSS imports for proper Vite handling */
.tactics-bg {
  background-image: url('../assets/images/technique.jpg');
}
...
.mentorship-bg {
  background-image: url('../assets/images/mental.png');
  background-position: center;
}
